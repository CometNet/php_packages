...
<head>
    ...
    <link rel="stylesheet" href="/vendor/admin/AdminLTE/plugins/glyphicon/glyphicon.css">
    <link href="https://s2.pstatp.com/cdn/expire-1-M/nprogress/0.2.0/nprogress.min.css" type="text/css" rel="stylesheet" />
    <link rel="stylesheet" href="/vendor/admin/AdminLTE/plugins/select2/css/select2.min.css">
    <link rel="stylesheet" href="/vendor/admin/AdminLTE/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
...
<!-- Bootstrap 4 -->
<script src="/vendor/admin/AdminLTE/plugins/bootstrap/js/bootstrap.bundle.js"></script>
<script src="/vendor/admin/AdminLTE/plugins/bootstrap/js/bootstrap.min.js"></script>
<!-- AdminLTE App -->
...
<script src="https://s1.pstatp.com/cdn/expire-1-M/nprogress/0.2.0/nprogress.js" type="application/javascript"></script>
<script src="/vendor/admin/select2/dist/js/select2.min.js"></script>
<script src="https://s1.pstatp.com/cdn/expire-1-M/bootstrap-sweetalert/1.0.1/sweetalert.min.js" type="application/javascript"></script>
<script>
    function LA() {}
    LA.token = "{{csrf_token()}}";
