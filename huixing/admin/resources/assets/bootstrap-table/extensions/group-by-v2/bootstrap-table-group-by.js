	  ...
	  if (this.options.groupBy && this.options.groupByField !== '') {
	    ...
	    if (this.options.groupByToggle) {
	      this.$container.off('click', '.groupBy').on('click', '.groupBy', function () {
	        $__default['default'](this).toggleClass('expanded collapsed');
	        $__default['default'](this).find('span').toggleClass("".concat(that.options.icons.collapseGroup, " ").concat(that.options.icons.expandGroup));
	        that.$body.find("tr[data-parent-index=".concat($__default['default'](this).closest('tr').data('group-index'), "]")).toggleClass('hidden');
	      });
	    }
