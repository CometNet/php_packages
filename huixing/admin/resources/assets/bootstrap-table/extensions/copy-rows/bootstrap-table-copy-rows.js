(function (global, factory) {
	...
	*/
	...
	$__default['default'].extend($__default['default'].fn.bootstrapTable.defaults.icons, {
	  ...
	  }[$__default['default'].fn.bootstrapTable.theme] || 'fa-copy'
	});

	var copyText = function copyText(text) {
	  var textField = document.createElement('textarea');
	  $__default['default'](textField).html(text);
	  ...
	  $__default['default'](textField).remove();
	};
	...
	$__default['default'].fn.bootstrapTable.methods.push('copyColumnsToClipboard');
	...
	$__default['default'].BootstrapTable = /*#__PURE__*/function (_$$BootstrapTable) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function copyColumnsToClipboard() {
	      ...
	      var rows = [];
	      $__default['default'].each(this.getSelections(), function (index, row) {
	        var cols = [];
	        $__default['default'].each(_this2.options.columns[0], function (indy, column) {
