...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="/vendor/admin/AdminLTE//plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
...
<div class="register-box">
    <div class="register-logo">
        <a href="/vendor/admin/AdminLTE//index2.html"><b>注册</a>
    </div>
    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <a href="{{ucenter_base_path('auth/login')}}" class="text-center">登录</a>
        </div>
        <!-- /.form-box -->
    </div><!-- /.card -->
</div>
